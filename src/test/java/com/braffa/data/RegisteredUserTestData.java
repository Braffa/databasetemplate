...
public class RegisteredUserTestData {
	...
	public RegisteredUser setUpRegisteredUser7() {
		RegisteredUser registeredUser = new RegisteredUser.RegisteredUserBuilder().authorityLevel("99").userId("admin")
				.email("andrew.jones@yahoo.co.uk").firstname("andrew").lastname("jones").password("kelly1233").telephone("01642 356745")
				.build();
		return registeredUser;
	}
