...
import com.braffa.model.Product;
import com.braffa.sqlqueries.ProductSQL;
	...
	private List<Product> processResultSet(ResultSet rs) throws SQLException {
		...
		while (rs.next()) {
			Product product = new Product.ProductBuilder().author(rs.getString("author"))
					...
					.imageLargeURL(rs.getString("imageLargeURL"))
					.manufacturer(rs.getString("manufacturer"))
					.productIndex(rs.getString("productIndex"))
					.productgroup(rs.getString("productgroup"))
					.productId(rs.getString("productId"))
					.productidtype(rs.getString("productidtype"))
